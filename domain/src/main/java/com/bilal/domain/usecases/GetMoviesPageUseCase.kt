...
data class GetMoviesPageParams(val apiKey: String, val page: Int, val query: String? = null)
...
class GetMoviesPageUseCase(private val moviesRepo: IMoviesRepo) :
    ...
    override suspend fun invoke(params: GetMoviesPageParams): DataHolder<List<Movie>> {
        return try {
            val movies = moviesRepo.getMoviesPage(params.apiKey, params.page, params.query)
